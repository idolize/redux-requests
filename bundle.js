...
function addDelay(delayMs) {
  ...
  return function (response) {
    return new Promise(function (resolve) {
      return setTimeout(resolve.bind(_this, response), delayMs);
    });
  };
}
...
function loadRepos(userId) {
  return function (dispatch, getState) {
    ...
    if (!dispatch({
      ...
      meta: {
        httpRequest: { url: url, done: false }
      }
    })) {
    ...
    var end = { url: url, done: true };
    fetch(url).then(checkStatus).then(parseJSON).then(addDelay(5000)).then(function (response) {
      return dispatch({
        type: 'LOAD_REPOS',
        payload: {
          userId: userId,
...
function githubRepos(state, action) {
  ...
  switch (action.type) {
    case 'LOAD_REPOS':
      return _extends({}, state, _defineProperty({}, payload.userId, {
...
var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2['default'], (0, _index.createRequestMiddleware)())(_redux.createStore);
var store = createStoreWithMiddleware((0, _redux.combineReducers)({ requests: _index.requestsReducer, githubRepos: githubRepos }));

// React component

var ReactComp = (function (_React$Component) {
  _inherits(ReactComp, _React$Component);

  function ReactComp() {
    _classCallCheck(this, ReactComp);

    _get(Object.getPrototypeOf(ReactComp.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(ReactComp, [{
    key: 'handleClick',
    value: function handleClick() {
      var onFetchReposClick = this.props.onFetchReposClick;

      var usernameNode = (0, _react.findDOMNode)(this.refs.username);
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'h1',
          null,
          'GitHub Pending Requests Example'
        ),
        _react2['default'].createElement(
          'p',
          { style: { padding: 5, color: 'grey' } },
          'Click to load data for a user, and watch the network requests in your browser dev tools: no new requests will be made for the same URL while there is already a request for that URL in flight (the request is delayed by 5 seconds to better illustrate the point)'
        ),
        _react2['default'].createElement(
          'div',
          ...
          _react2['default'].createElement(
            'span',
            null,
            _react2['default'].createElement('input', { ref: 'username', placeholder: 'GitHub username', defaultValue: 'idolize' })
          ),
          ' ',
          _react2['default'].createElement(
            'button',
...
function formatRepos(reposByUser) {
  ...
  Object.keys(reposByUser).forEach(function (user) {
    var userPayload = reposByUser[user];
    out[user] = userPayload.loading ? 'Loading...' : userPayload.error ? userPayload.error : userPayload.resp ? userPayload.resp.map(function (repo) {
      return repo && (repo.name || repo);
    }) : undefined;
  });
...
function mapDispatchToProps(dispatch) {
  return {
    onFetchReposClick: function onFetchReposClick(userId) {
...
// Connected Component
var App = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ReactComp);
...
},{"../index":183,"es6-promise":2,"react":167,"react-redux":6,"redux":171,"redux-thunk":168,"whatwg-fetch":182}],2:[function(require,module,exports){
...
},{"../utils/createStoreShape":7,"../utils/isPlainObject":8,"../utils/shallowEqual":9,"../utils/shallowEqualScalar":10,"../utils/wrapActionCreators":11,"_process":181,"invariant":12}],5:[function(require,module,exports){
'use strict';
...
},{"./components/createAll":3,"react":167}],7:[function(require,module,exports){
"use strict";
...
},{"./CSSProperty":15,"./ExecutionEnvironment":32,"./camelizeStyleName":120,"./dangerousStyleValue":125,"./hyphenateStyleName":145,"./memoizeStringOnly":155,"./warning":166,"_process":181}],17:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":38,"./PooledClass":39,"./invariant":147,"_process":181}],18:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":23,"./ReactMultiChildUpdateTypes":84,"./invariant":147,"./setTextContent":161,"_process":181}],21:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":147,"_process":181}],22:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":21,"./quoteAttributeValueForBrowser":159,"./warning":166,"_process":181}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":32,"./createNodesFromMarkup":124,"./emptyFunction":126,"./getMarkupWrap":139,"./invariant":147,"_process":181}],24:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./emptyFunction":126,"_process":181}],28:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginRegistry":29,"./EventPluginUtils":30,"./accumulateInto":117,"./forEachAccumulated":132,"./invariant":147,"_process":181}],29:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":147,"_process":181}],30:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":26,"./invariant":147,"_process":181}],31:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":26,"./EventPluginHub":28,"./accumulateInto":117,"./forEachAccumulated":132,"_process":181}],32:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypes":90,"./invariant":147,"_process":181}],36:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactBrowserEventEmitter":42,"./accumulateInto":117,"./forEachAccumulated":132,"./invariant":147,"_process":181}],37:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":147,"_process":181}],40:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./PooledClass":39,"./ReactFragment":75,"./traverseAllChildren":165,"./warning":166,"_process":181}],45:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactUpdateQueue":98,"./invariant":147,"./warning":166,"_process":181}],47:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":147,"_process":181}],49:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":38,"./emptyObject":127,"./warning":166,"_process":181}],51:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":69,"./ReactElementValidator":70,"./mapObject":154,"_process":181}],53:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSPropertyOperations":16,"./DOMChildrenOperations":20,"./DOMPropertyOperations":22,"./ReactMount":82,"./ReactPerf":87,"./invariant":147,"./setInnerHTML":160,"_process":181}],57:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":13,"./DOMPropertyOperations":22,"./LinkedValueUtils":35,"./Object.assign":38,"./ReactBrowserComponentMixin":41,"./ReactClass":45,"./ReactElement":69,"./ReactMount":82,"./ReactUpdates":99,"./invariant":147,"_process":181}],60:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactBrowserComponentMixin":41,"./ReactClass":45,"./ReactElement":69,"./warning":166,"_process":181}],61:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":13,"./DOMPropertyOperations":22,"./LinkedValueUtils":35,"./Object.assign":38,"./ReactBrowserComponentMixin":41,"./ReactClass":45,"./ReactElement":69,"./ReactUpdates":99,"./invariant":147,"./warning":166,"_process":181}],65:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./BeforeInputEventPlugin":14,"./ChangeEventPlugin":18,"./ClientReactRootIndex":19,"./DefaultEventPluginOrder":24,"./EnterLeaveEventPlugin":25,"./ExecutionEnvironment":32,"./HTMLDOMPropertyConfig":34,"./MobileSafariClickEventPlugin":37,"./ReactBrowserComponentMixin":41,"./ReactClass":45,"./ReactComponentBrowserEnvironment":47,"./ReactDOMButton":53,"./ReactDOMComponent":54,"./ReactDOMForm":55,"./ReactDOMIDOperations":56,"./ReactDOMIframe":57,"./ReactDOMImg":58,"./ReactDOMInput":59,"./ReactDOMOption":60,"./ReactDOMSelect":61,"./ReactDOMTextComponent":63,"./ReactDOMTextarea":64,"./ReactDefaultBatchingStrategy":65,"./ReactDefaultPerf":67,"./ReactElement":69,"./ReactEventListener":74,"./ReactInjection":76,"./ReactInstanceHandles":78,"./ReactMount":82,"./ReactReconcileTransaction":92,"./SVGDOMPropertyConfig":100,"./SelectEventPlugin":101,"./ServerReactRootIndex":102,"./SimpleEventPlugin":103,"./createFullPageComponent":123,"_process":181}],67:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":38,"./ReactContext":50,"./ReactCurrentOwner":51,"./warning":166,"_process":181}],70:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":51,"./ReactElement":69,"./ReactFragment":75,"./ReactNativeComponent":85,"./ReactPropTypeLocationNames":88,"./ReactPropTypeLocations":89,"./getIteratorFn":138,"./invariant":147,"./warning":166,"_process":181}],71:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":69,"./ReactInstanceMap":79,"./invariant":147,"_process":181}],72:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":69,"./warning":166,"_process":181}],76:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":95,"./invariant":147,"_process":181}],79:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":38,"./invariant":147,"_process":181}],86:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":147,"_process":181}],87:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElementValidator":70,"./ReactRef":94,"_process":181}],94:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":69,"./ReactInstanceHandles":78,"./ReactMarkupChecksum":81,"./ReactServerRenderingTransaction":97,"./emptyObject":127,"./instantiateReactComponent":146,"./invariant":147,"_process":181}],97:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":38,"./ReactCurrentOwner":51,"./ReactElement":69,"./ReactInstanceMap":79,"./ReactLifeCycle":80,"./ReactUpdates":99,"./invariant":147,"./warning":166,"_process":181}],99:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":17,"./Object.assign":38,"./PooledClass":39,"./ReactCurrentOwner":51,"./ReactPerf":87,"./ReactReconciler":93,"./Transaction":115,"./invariant":147,"./warning":166,"_process":181}],100:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":147,"_process":181}],116:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":147,"_process":181}],118:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactClass":45,"./ReactElement":69,"./invariant":147,"_process":181}],124:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":32,"./createArrayFromMixed":122,"./getMarkupWrap":139,"./invariant":147,"_process":181}],125:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":181}],128:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":51,"./ReactInstanceMap":79,"./ReactMount":82,"./invariant":147,"./isNode":149,"./warning":166,"_process":181}],130:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":165,"./warning":166,"_process":181}],131:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":32,"./invariant":147,"_process":181}],140:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":38,"./ReactCompositeComponent":49,"./ReactEmptyComponent":71,"./ReactNativeComponent":85,"./invariant":147,"./warning":166,"_process":181}],147:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":181}],148:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":147,"_process":181}],153:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":69,"./invariant":147,"_process":181}],157:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./warning":166,"_process":181}],164:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":147,"_process":181}],165:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":69,"./ReactFragment":75,"./ReactInstanceHandles":78,"./getIteratorFn":138,"./invariant":147,"./warning":166,"_process":181}],166:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":126,"_process":181}],167:[function(require,module,exports){
...
},{"./utils/isPlainObject":177,"invariant":180}],170:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./Store":169}],171:[function(require,module,exports){
// Core
'use strict';
...
},{"./createStore":170,"./utils/applyMiddleware":172,"./utils/bindActionCreators":173,"./utils/combineReducers":174,"./utils/compose":175,"./utils/composeMiddleware":176}],172:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./compose":175,"./composeMiddleware":176}],173:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../utils/mapValues":178}],174:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../Store":169,"../utils/mapValues":178,"../utils/pick":179,"invariant":180}],175:[function(require,module,exports){
/**
...
module.exports = exports['default'];
},{"./compose":175}],177:[function(require,module,exports){
'use strict';
...
},{"_process":181,"dup":12}],181:[function(require,module,exports){
